...
- OGP: `/Users/8ega4/dev/yorimichi-quest/public/ogp.jpg`
...
| OGP | 1200 × 630 | Pass — exact product title, value proposition, luminous route, flags, and miniature town remain legible. |
...
- OGP text and title artwork were composited deterministically from local assets to avoid generated-text errors.
